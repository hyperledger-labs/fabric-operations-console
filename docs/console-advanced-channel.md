...
For an overview of the channel creation process that ignores the advanced options, see [Step four: Create a channel](console-build-network.md#step-four-create-a-channel).
