...
>**_IMPORTANT:_** You also have the ability to choose the version of Fabric that will be used to deploy your ordering nodes. It is recommended to always choose the latest version, as this version will have the latest fixes and improvements. Note that it is currently not possible to enable any v2.0 <a href="https://hyperledger-fabric.readthedocs.io/en/release-2.0/capabilities_concept.html" target="_blank">Fabric capabilities <img src="/docs/images/external.png" width="10" alt="external" valign="middle"></a>.
