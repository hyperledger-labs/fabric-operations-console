...
Fabric Operatons Console enables you to develop, deploy, and operate fabric applications and networks. You can learn more about fabric components and how they work together by visiting the [component overview](/docs/getting_started/component_overview.md). This tutorial is the second part in the [sample network tutorial series](/docs/getting_started/console-build-network.md#sample-network-tutorial-series) and describes how to create nodes in the Fabric  Operatons Console and connect them to a fabric consortium hosted in another cluster.
...
If you have not already deployed your Fabric  Operatons Console to a cluster, see [getting started with Fabric  Operatons Console](/docs/getting_started/getting-started.md).  

You need to pay close attention to the resources at your disposal when you choose to deploy nodes and create channels. It is your responsibility to manage your cluster and deploy additional resources if necessary. For more information about component sizings and how the console interacts with your service cluster, see [allocating resources](/docs/using_console/console-advanced-deployment.md#allocating-resources).
...
* [Build a network tutorial](/docs/getting_started/console-build-network.md#build-a-network) guides you through the process of hosting a network by creating an ordering service and a peer.
...
* [Deploy a smart contract using Fabric v2.x](/docs/smart_contracts/console-smart-contracts-v2.md) provides information on how to write a smart contract and deploy it on your network.
...
* **Joining one channel**
  The tutorial describes how to join the channel that was created by the [build a network tutorial](/docs/getting_started/console-build-network.md#build-a-network).
...
Advanced users may already have their own CA, and not want to create a new CA in the console. If your existing CA can issue certificates in `X.509` format, you can use certificates from your own third-party CA instead of creating new certificates here. The CA should sign using ECDSA and the defaults should be set to use P256 curve. See this topic on [using certificates from an external CA with your peer or ordering node](/docs/using_console/console-advanced-deployment.md#using-certificates-from-an-external-ca-with-your-peer-or-ordering-service) for more information.
...
For more information about MSPs, see [managing organizations](/docs/using_console/console-organizations.md#managng-organizations).

### Creating a peer

After you have [created a CA](/docs/getting_started/console-join-network.md#creating-your-peer-organization-ca), used it to register identities, and created the [peer organization MSP](/docs/getting_started/console-join-network.md#creating-your-peer-organization-ca), you're ready to create a peer.
...
In the [build a network tutorial](/docs/getting_started/console-build-network.md#build-a-network), Org1 created a channel, `channel1`, with itself as the only member. For Org2 to join this channel, it must export its MSP to Org1:
...
- [Deploy a smart contract on your network using Fabric v2.x](/docs/smart_contracts/console-smart-contracts-v2.md) using the console.
- After you have installed and instantiated your smart contract, you can [submit transactions using your client application](/docs/using_console/console-create-app.md). The [commercial paper sample](/docs/using_console/console-create-app.md#running-the-commercial-paper-sample) can be used to deploy an example smart contract and submit transactions from sample application code.
