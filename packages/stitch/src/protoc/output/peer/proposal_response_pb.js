...
/**
 * optional bytes fabric_extension = 2;
 * @return {!(string|Uint8Array)}
 */
proto.protos.ProposalResponsePayload.prototype.getFabricExtension = function() {
 ...
 * @return {string}
 */
proto.protos.ProposalResponsePayload.prototype.getFabricExtension_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
 ...
 * @return {!Uint8Array}
 */
proto.protos.ProposalResponsePayload.prototype.getFabricExtension_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getFabricExtension()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.protos.ProposalResponsePayload.prototype.setFabricExtension = function(value) {
