...
export class MSPPrincipal extends jspb.Message {
  ...
  setPrincipalClassification(value: MSPPrincipal.Classification): void;
...
export class MSPRole extends jspb.Message {
  ...
  setRole(value: MSPRole.MSPRoleType): void;
...
export class MSPIdentityAnonymity extends jspb.Message {
  ...
  setAnonymityType(value: MSPIdentityAnonymity.MSPIdentityAnonymityType): void;
