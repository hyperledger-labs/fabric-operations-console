...
# 	#Login entry
# 	And I provided 'user logging into the IBP console - local' for the 'Search activity logs' input
# 	Then I should see audit log row with text 'user logging into the IBP console - local' and id 'audit-logs-log_title-0'
...
# 	When I provided 'user is changing their password' for the 'Search activity logs' input
# 	Then I should see audit log row with text 'user logging into the IBP console - local' and id 'audit-logs-log_title-0'
...
# 	When I provided 'adding new fabric-ca' for the 'Search activity logs' input
# 	Then I should see audit log row with text 'adding new fabric-ca' and id 'audit-logs-log_title-0'
# 	Then I should see audit log row with text 'success' and id 'audit-logs-outcome_title-0'
# 	# When I provided 'adding new fabric-ca "org2ca"' for the 'Search activity logs' input
...
# 	# When I provided 'adding new fabric-peer "peerorg1"' for the 'Search activity logs' input
...
# 	# When I provided "adding identity to user's wallet" for the 'Search activity logs' input
...
# 	# When I provided 'registering identity "org1admin" on CA "org1ca"' for the 'Search activity logs' input
...
# 	# When I provided 'registering identity "peer1" on CA "org1ca"' for the 'Search activity logs' input
...
# 	# When I provided 'exporting component "Org1 MSP Admin"' for the 'Search activity logs' input
...
# 	# When I provided 'adding new msp "org1msp"' for the 'Search activity logs' input
...
# 	# When I provided 'adding new fabric-orderer "orderingservicenode1"' for the 'Search activity logs' input
...
# 	# When I provided 'updating channel "testchainid" - MSP "osmsp"' for the 'Search activity logs' input
...
# 	# When I provided 'creating channel "channel2" - MSP "org1msp"' for the 'Search activity logs' input
...
# 	# When I provided 'creating a signature collection for channel "channel2"' for the 'Search activity logs' input
...
# 	# When I provided 'editing a signature collection for channel "channel2"' for the 'Search activity logs' input
...
# 	# When I provided 'peers"Peer Org1", "Peer Org2" havejoined the channel "channel2"' for the 'Search activity logs' input
...
# 	# When I provided 'updating channel "channel2" - MSP "org2msp"' for the 'Search activity logs' input
...
# 	# When I provided 'creating channel "channel1" - MSP "org1msp"' for the 'Search activity logs' input
...
# 	# When I provided 'installing chaincode "fabcar" @ "2.1.1" on peer "Peer Org2"' for the 'Search activity logs' input
...
# 	# When I provided 'instantiating chaincode "fabcar" @ "2.1.1" on channel "channel1"' for the 'Search activity logs' input
...
# 	# When I provided 'editing component "peerorg1" - "version", "replicas", "ignore_warnings"' for the 'Search activity logs' input
...
# 	# When I provided 'editing component "orderingservicenode1" - "version", "replicas"' for the 'Search activity logs' input
...
# 	# When I provided 'creating a config block doc - channel "channel5"' for the 'Search activity logs' input
...
# 	# When I provided 'archiving a config block doc - channel "channel5"' for the 'Search activity logs' input
...
# 	# When I provided 'bulk export of 10 components' for the 'Search activity logs' input
...
# 	# When I provided 'importing 4 items from zip' for the 'Search activity logs' input
...
# 	# When I provided 'adding new msp "ca_importmsp"' for the 'Search activity logs' input
...
# 	# When I provided 'adding new fabric-peer "peer_import"' for the 'Search activity logs' input
...
# 	# When I provided 'adding new fabric-orderer "os_import_1"' for the 'Search activity logs' input
...
# 	# When I provided 'adding new fabric-ca "ca_import"' for the 'Search activity logs' input
...
# 	# When I provided 'deleting fabric-orderer "os_import_1"' for the 'Search activity logs' input
# 	# Then I should see audit log row with text 'deleting fabric-orderer "os_import_1"' and id 'audit-logs-log_title-0'
...
# 	# When I provided 'deleting fabric-ca "ca_import"' for the 'Search activity logs' input
# 	# Then I should see audit log row with text 'deleting fabric-ca "ca_import"' and id 'audit-logs-log_title-0'
...
# 	# When I provided 'deleting fabric-peer "peer_import"' for the 'Search activity logs' input
# 	# Then I should see audit log row with text 'deleting fabric-peer "peer_import"' and id 'audit-logs-log_title-0'
# 	# Then I should see audit log row with text 'success' and id 'audit-logs-outcome_title-0'
