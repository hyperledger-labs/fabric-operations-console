...
Feature: Verify Audit Log functionality works as expected
  ...
  Scenario: Search activity log with manager user
	...
	#Login entry
	And I provided 'user logging in - local' for input field with class ".cds--search-input"
	...
	When I provided 'user is changing their password' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for adding CA
	...
	When I provided 'adding new fabric-ca "org2ca"' for input field with class ".cds--search-input"
	Then I should see audit log row with text 'adding new fabric-ca "org2ca"' and id 'audit-logs-log_title-0'
	Then I should see audit log row with text 'success' and id 'audit-logs-outcome_title-0'
	When I provided 'adding new fabric-ca "org1ca"' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for adding Peer
	...
	Then I reload the page
	When I provided 'adding new fabric-peer "peerorg1"' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for identity and Ordering Service
	...
	When I provided "adding identity to user's wallet" for input field with class ".cds--search-input"
	...
	When I provided 'registering identity "org1admin" on CA "org1ca"' for input field with class ".cds--search-input"
	...
	When I provided 'registering identity "peer1" on CA "org1ca"' for input field with class ".cds--search-input"
	...
	Then I reload the page
	When I provided 'exporting component "Org1 MSP Admin"' for input field with class ".cds--search-input"
	...
	When I provided 'adding new msp "org1msp"' for input field with class ".cds--search-input"
	...
	When I provided 'adding new fabric-orderer "orderingservicenode1"' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for creating channel and joining channel
	...
	When I provided 'peers "Peer Org1", "Peer Org2" have joined the channel "channel2"' for input field with class ".cds--search-input"
	...
	When I provided 'updating channel "testchainid" - MSP "osmsp"' for input field with class ".cds--search-input"
	...
	When I provided 'creating channel "channel1" - MSP "org1msp"' for input field with class ".cds--search-input"
	...
	When I provided 'creating a config block doc - channel "channel5"' for input field with class ".cds--search-input"
	...
	When I provided 'archiving a config block doc - channel "channel5"' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for updating channel and installing chaincode
	...
	When I provided 'creating a signature collection for channel "channel2" ' for input field with class ".cds--search-input"
	...
	When I provided 'editing a signature collection for channel "channel2"' for input field with class ".cds--search-input"
	...
	When I provided 'updating channel "channel2" - MSP "org2msp"' for input field with class ".cds--search-input"
	...
	When I provided 'installing chaincode "fabcar" @ "2.1.1" on peer' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for export and import
	...
	When I provided 'bulk export of 10 components' for input field with class ".cds--search-input"
	...
	When I provided 'importing 4 items from zip' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for importing CA, Peer and Ordering Service node
	...
	When I provided 'adding new msp "ca_importmsp"' for input field with class ".cds--search-input"
	...
	When I provided 'adding new fabric-peer "peer_import"' for input field with class ".cds--search-input"
	...
	When I provided 'adding new fabric-orderer "os_import_1"' for input field with class ".cds--search-input"
	...
	When I provided 'adding new fabric-ca "ca_import"' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for deleting CA, Peer and Ordering Service node
	...
	When I provided 'removing fabric-orderer "os_import_1"' for input field with class ".cds--search-input"
	...
	When I provided 'removing fabric-ca "ca_import"' for input field with class ".cds--search-input"
	...
	When I provided 'removing fabric-peer "peer_import"' for input field with class ".cds--search-input"
	...
	#delete org1ca
	When I provided 'removing fabric-ca "org1ca"' for input field with class ".cds--search-input"
	Then I should see audit log row with text 'removing fabric-ca "org1ca"' and id 'audit-logs-log_title-0'
	Then I should see audit log row with text 'success' and id 'audit-logs-outcome_title-0'
	#delete peerOrg1
	Then I reload the page
	When I provided 'removing fabric-peer "peerorg1"' for input field with class ".cds--search-input"
	...
	When I provided 'deleting ordering service: "Ordering Service"' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for adding user
	...
	When I provided 'adding new user w********r@ibm.com' for input field with class ".cds--search-input"
	...
	When I provided 'adding new user r********r@ibm.com' for input field with class ".cds--search-input"
  ...
  Scenario: Search activity log for deleting user
	...
	When I provided 'deleting users w********r@ibm.com, r********r@ibm.com' for input field with class ".cds--search-input"
